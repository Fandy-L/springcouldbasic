...
public class Response {
    ...
    public static final ResultStatusResponse<String> TEMPLATE_CREATE_SUCCESS = new ResultStatusResponse(1, "模板创建成功");
    public static final ResultStatusResponse<String> TEMPLATE_CREATE_FAIL = new ResultStatusResponse(0, "模板创建失败");
}
