...
public class MyDateTimeUtils {
     ...
     * @return
     */
    public static Date getDayBeginOfYesterday() {
        Calendar cal = new GregorianCalendar();
     ...
     * @return
     */
    public static Date getDayBeginOfTomorrow() {
        Calendar cal = new GregorianCalendar();
        cal.setTime(getDayBegin());
        cal.add(Calendar.DAY_OF_MONTH, 1);
     ...
     * @return
     */
    public static Date getDayEndOfTomorrow() {
        Calendar cal = new GregorianCalendar();
        cal.setTime(getDayEnd());
        cal.add(Calendar.DAY_OF_MONTH, 1);
        return cal.getTime();
     ...
     */
    @SuppressWarnings("unused")
    public static Date getDayBeginOfLastWeek() {
        Date date = new Date();
        Calendar cal = Calendar.getInstance();
        cal.setTime(date);
        int dayofweek = cal.get(Calendar.DAY_OF_WEEK);
     ...
     * @return
     */
    public static Date getDayEndOfLastWeek() {
        Calendar cal = Calendar.getInstance();
        cal.setTime(getDayBeginOfLastWeek());
        cal.add(Calendar.DAY_OF_WEEK, 6);
        Date weekEndSta = cal.getTime();
        return getDayEndTime(weekEndSta);
    }
     ...
     * @return
     */
    public static Date getDayBeginOfLastMonth() {
        Calendar calendar = Calendar.getInstance();
     ...
     * @return
     */
    public static Date getDayEndOfLastMonth() {
        Calendar calendar = Calendar.getInstance();
        calendar.set(getNowYear(), getNowMonth() - 2, 1);
        int day = calendar.getActualMaximum(5);
